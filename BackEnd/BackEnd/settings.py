...
SECRET_KEY = 'django-insecure-dx&t@mc$cu58)(vracg^hx5rlqk-5st$d!bq4pu5i)kp(f6@()'
...
MEDIA_URL = '/uploads/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'uploads') #ESTO SIRVE PARA QUE TE PUEDAN SUBIR MEDIAS A TU SERVIDOR
